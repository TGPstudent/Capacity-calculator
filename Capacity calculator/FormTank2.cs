...
{
    public partial class FormTank2 : MetroForm
    {
        ...
        private void button_Calculate_Click(object sender, EventArgs e)
        {
            try
            {
                Tank2 tank2 = new Tank2(textBox_D.Text, textBox_H.Text, textBox_H1.Text, textBox_H2.Text);
                textBox_Rez.Text = tank2.Print();
                _In = tank2.InArh();
                _Out = tank2.OutArh();
            }
