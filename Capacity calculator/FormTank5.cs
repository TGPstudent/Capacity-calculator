...
{
    public partial class FormTank5 : MetroForm
    {
        ...
        private void button_Calculate_Click(object sender, EventArgs e)
        {
            try
            {
                Tank5 tank5 = new Tank5(textBox_A.Text, textBox_B.Text, textBox_H.Text, textBox_H1.Text, textBox_H2.Text);
                textBox_Rez.Text = tank5.Print();
                _In = tank5.InArh();
                _Out = tank5.OutArh();
            }
