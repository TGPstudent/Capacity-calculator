...
{
    public partial class FormTank3 : MetroForm
    {
        ...
        {
            ColorLabel(textBox_D1, label_D1);
        }
        ...
        private void button_Calculate_Click(object sender, EventArgs e)
        {
            try
            {
                Tank3 tank3 = new Tank3(textBox_D.Text, textBox_H.Text, textBox_H1.Text, textBox_H2.Text, textBox_D1.Text);
                textBox_Rez.Text = tank3.Print();
                _In = tank3.InArh();
                _Out = tank3.OutArh();
            }
